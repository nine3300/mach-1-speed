...
(function() {
  ...
  function D2(d, a) {
    ...
    if (C2(d))
      return new H2(w, w);
    if (B2(d))
      return a = D2(x2(d), a), new H2(x2(a.g), x2(a.h));
    if (B2(a))
      return a = D2(d, x2(a)), new H2(x2(a.g), a.h);
    if (d.g.length > 30) {
      if (B2(d) || B2(a))
        throw Error("slowDivide_ only works with positive integers.");
      for (var c = z2, f = a; f.l(d) <= 0; )
        c = I(c), f = I(f);
...
// ../../node_modules/.pnpm/@firebase+webchannel-wrapper@1.0.5/node_modules/@firebase/webchannel-wrapper/dist/webchannel-blob/esm/webchannel_blob_es2018.js
...
(function() {
  ...
  function t(a, b) {
    ...
    a.Ob = function(d, e, f) {
      for (var g = Array(arguments.length - 2), k2 = 2; k2 < arguments.length; k2++)
        g[k2 - 2] = arguments[k2];
  ...
  function Na(a, b, c, d, e, f) {
    ...
    if (a.addEventListener)
      ua || (e = g), e === void 0 && (e = false), a.addEventListener(b.toString(), d, e);
  ...
  function Sa(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (d = n(d) ? !!d.capture : !!d, c = Ma(c), a && a[B2]) ? (a = a.i, f = String(b).toString(), f in a.g && (b = a.g[f], c = Fa(b, c, d, e), c > -1 && (xa(b[c]), Array.prototype.splice.call(b, c, 1), b.length == 0 && (delete a.g[f], a.h--)))) : a && (a = Oa(a)) && (b = a.g[b.toString()], a = -1, b && (a = Fa(b, c, d, e)), (c = a > -1 ? b[a] : null) && Ta(c));
  }
  function Ta(a) {
          ...
          if (!(k2 < 3) && (k2 != 3 || this.g && (this.h.h || this.g.la() || Ib(this.g)))) {
            ...
            if (this.o) {
              if (this.U && !this.L) {
                ...
                if (a = f)
                  K2(this.i, this.l, a, "Initial handshake response via X-HTTP-Initial-Response"), this.L = true, Lb(this, a);
                else {
                  this.o = false;
                  this.m = 3;
                  J2(12);
              ...
              if (this.R) {
                ...
                for (; !this.K && this.C < c.length; )
                  if (r = Nb(this, c), r == Bb) {
                    ...
                    K2(this.i, this.l, r, null), Lb(this, r);
                ...
                K2(this.i, this.l, c, null), Lb(this, c);
              k2 == 4 && Q2(this);
              this.o && !this.K && (k2 == 4 ? Qb(this.j, this) : (this.o = false, Fb(this)));
            } else
              Rb(this.g), b == 400 && c.indexOf("Unknown SID") > 0 ? (this.m = 3, J2(12)) : (this.m = 0, J2(13)), Q2(this), Mb(this);
          }
        }
    } catch (k2) {
    } finally {
  ...
  T.prototype.toString = function() {
    ...
    var c = this.g;
    if (c || b == "file")
      a.push("//"), (b = this.o) && a.push(qc(b, rc, true), "@"), a.push(L2(c).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.u, c != null && a.push(":", String(c));
    if (c = this.h)
    ...
    a: {
      ...
      for (; ; ) {
        ...
        for (let r = 0; r < c; r++) {
          ...
          f -= k2;
          if (f < 0)
            k2 = Math.max(0, e[r].g - 100), m = false;
          else
            try {
              f = "req" + f + "_" || "";
              try {
...
// ../../node_modules/.pnpm/@firebase+firestore@4.11.0_@firebase+app@0.14.8/node_modules/@firebase/firestore/dist/common-3cb50c20.esm.js
var User = class {
  constructor(e) {
    this.uid = e;
  }
...
function __PRIVATE_validateJSON(e, t) {
  if (!__PRIVATE_isPlainObject(e))
    throw new FirestoreError(C.INVALID_ARGUMENT, "JSON must be an object");
  let n;
  for (const r in t)
    if (t[r]) {
  ...
  if (n)
    throw new FirestoreError(C.INVALID_ARGUMENT, n);
  return true;
}
var O = -62135596800;
var N = 1e6;
...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== C.FAILED_PRECONDITION || e.message !== L)
    throw e;
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (__PRIVATE_logDebug(k, "Transaction failed with error:", t2.message, "Retrying:", n2), this.close(), !n2)
...
var __PRIVATE_IndexBackfiller = class {
  ...
  se(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(q, `Processing collection: ${t2}`), this.oe(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
...
function __PRIVATE_decodeResourcePath(e) {
  ...
  if (__PRIVATE_hardAssert(t >= 2, 64408, {
    ...
    return __PRIVATE_hardAssert(e.charAt(0) === $ && "" === e.charAt(1), 56145, {
      path: e
  ...
  switch (n) {
    ...
    case 11:
      return function __PRIVATE_compareMaps(e2, t2) {
        if (e2 === at.mapValue && t2 === at.mapValue)
          return 0;
        if (e2 === at.mapValue)
          return 1;
        if (t2 === at.mapValue)
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  let n;
  if (t.document)
    n = __PRIVATE_fromDocument(e.yt, t.document, !!t.hasCommittedMutations);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Ct(e, t) {
    if ("nullValue" in e)
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.kt(e.mapValue, t) : (this.Kt(e.mapValue, t), this.Nt(t)) : "arrayValue" in e ? (this.qt(e.arrayValue, t), this.Nt(t)) : fail(19022, {
        Ut: e
      });
  }
  Ot(e, t) {
  ...
  Zt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Gt(960 | e2 >>> 6), this.Gt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Gt(480 | e2 >>> 12), this.Gt(128 | 63 & e2 >>> 6), this.Gt(128 | 63 & e2);
      else {
  ...
  Xt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Ht(960 | e2 >>> 6), this.Ht(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Ht(480 | e2 >>> 12), this.Ht(128 | 63 & e2 >>> 6), this.Ht(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
  ...
  gn(e) {
    ...
    if (this.Vn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.yn(e2, t2) || !this.wn(this.dn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.dn.length || !this.wn(this.dn[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  xn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.qn(t, s.fieldPath) && isArray(e2))
          r = this.Un(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Nn(i2), r));
    } else
      n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, bt, r));
    return n;
  }
  /**
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      this.Jr = this.Jr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.ki = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
  ...
  async es() {
    if (this.isPrimary && !this.ts(this.Li, Mt)) {
      ...
      if (this.Ui)
        for (const t of e)
          this.Ui.removeItem(this.rs(t.clientId));
    }
  }
  /**
  ...
  runTransaction(e, t, n) {
    ...
    return this.qi.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next((e2) => !!e2 || this.Hi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Ci.enqueueRetryable(() => this.ki(false)), new FirestoreError(C.FAILED_PRECONDITION, L);
      return n(s);
  ...
  Ps(e) {
    return __PRIVATE_primaryClientStore(e).get(G).next((e2) => {
      if (null !== e2 && this.ts(e2.leaseTimestampMs, xt) && !this.ss(e2.ownerId) && !this.Xi(e2) && !(this.Mi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.gs(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.ps(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.li.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.Pi.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Hs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Ut, "EVENT", t.key, t.newValue), t.key === this.Xs)
  ...
  async mo(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.So(e.batchId, e.state, e.error);
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, () => {
      ...
      if (!l) {
        ...
        if (s2) {
          ...
          __PRIVATE_logDebug(zt, `RPC '${e}' stream ${r} received:`, n2), h.__(n2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.da.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.da.st(t) : e.da.tt(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  Ga(e) {
    ...
    if (e.qa.namedQuery)
      ...
      e.qa.document && (this.Qa[this.Qa.length - 1].document = e.qa.document, ++t);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.Vu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var __PRIVATE_BundleReaderSyncImpl = class {
  ...
  Uu(e) {
    if (this.cursor + e > this.bundleData.length)
      throw new FirestoreError(C.INTERNAL, "Reached the end of bundle when more is expected.");
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    if (void 0 === e.host) {
      ...
      this.host = e.host, this.ssl = e.ssl ?? rn;
    if (this.isUsingEmulator = void 0 !== e.emulatorOptions, this.credentials = e.credentials, this.ignoreUndefinedProperties = !!e.ignoreUndefinedProperties, this.localCache = e.localCache, void 0 === e.cacheSizeBytes)
      this.cacheSizeBytes = Dt;
    else {
      if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < vt)
...
function doc(e, t, ...n) {
  ...
  {
    if (!(e instanceof DocumentReference || e instanceof CollectionReference))
      throw new FirestoreError(C.INVALID_ARGUMENT, "Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    const r = e._path.child(ResourcePath.fromString(t, ...n));
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < vt)
    throw new FirestoreError(C.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
var ParseContextImpl = class _ParseContextImpl {
  ...
  validatePathSegment(e) {
    ...
    if (__PRIVATE_isWrite(this.dataSource) && _n.test(e))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.dataSource)
      throw 1 === e.dataSource ? e.createError(`${this._methodName}() can only appear at the top level of your update data`) : e.createError(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
  ...
  for (let e2 = 0; e2 < s.length; e2 += 2)
    _.push(__PRIVATE_fieldPathFromArgument(t, s[e2])), a.push(s[e2 + 1]);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.dataSource))
        throw t2.createError(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.createError(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.createError(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
          ...
          fields: {
            ...
            [ct]: {
              arrayValue: {
                values: n.map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.createError("VectorValues must only contain numeric values.");
...
// ../../node_modules/.pnpm/@firebase+firestore@4.11.0_@firebase+app@0.14.8/node_modules/@firebase/firestore/dist/index.esm.js
    ...
    const e = __PRIVATE_newUserDataReader(t.firestore), n = function __PRIVATE_newQueryFilter(t2, e2, n2, r, s, a, o) {
      ...
      if (s.isKeyField()) {
        if ("array-contains" === a || "array-contains-any" === a)
          throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid Query. You can't perform '${a}' queries on documentId().`);
        if ("in" === a || "not-in" === a) {
          __PRIVATE_validateDisjunctiveFilterElements(o, a);
          const e3 = [];
          for (const n3 of o)
            e3.push(__PRIVATE_parseDocumentIdValue(r, t2, n3));
          i = {
            arrayValue: {
              values: e3
            }
          ...
          i = __PRIVATE_parseDocumentIdValue(r, t2, o);
      } else
...
var QueryCompositeFilterConstraint = class _QueryCompositeFilterConstraint extends AppliableConstraint {
  ...
  _apply(t) {
    ...
    return 0 === e.getFilters().length ? t : (function __PRIVATE_validateNewFilter(t2, e2) {
      ...
      for (const t3 of r)
        __PRIVATE_validateNewFieldFilter(n, t3), n = __PRIVATE_queryWithAddedFilter(n, t3);
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1)
    return function __PRIVATE_newQueryBoundFromDocument(t2, e2, n2, r2, s) {
      if (!r2)
        throw new FirestoreError(C.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n2}().`);
      const a = [];
      for (const n3 of __PRIVATE_queryNormalizedOrderBy(t2))
        if (n3.field.isKeyField())
          a.push(__PRIVATE_refValue(e2, r2.key));
        else {
    ...
    return function __PRIVATE_newQueryBoundFromFields(t2, e2, n2, r2, s2, a) {
      ...
      for (let a2 = 0; a2 < s2.length; a2++) {
        ...
        if (o[a2].field.isKeyField()) {
          if ("string" != typeof u)
            throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r2}(), but got a ${typeof u}`);
          if (!__PRIVATE_isCollectionGroupQuery(t2) && -1 !== u.indexOf("/"))
            throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r2}() must be a plain document ID, but '${u}' contains a slash.`);
...
function __PRIVATE_parseDocumentIdValue(t, e, n) {
  ...
  if (n instanceof DocumentReference)
    return __PRIVATE_refValue(t, n._key);
...
function __PRIVATE_validateDisjunctiveFilterElements(t, e) {
  if (!Array.isArray(t) || 0 === t.length)
    throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
}
...
function __PRIVATE_validateQueryFilterConstraint(t, e) {
  if (!(e instanceof QueryFieldFilterConstraint || e instanceof QueryCompositeFilterConstraint))
    throw new FirestoreError(C.INVALID_ARGUMENT, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
var DocumentSnapshot = class _DocumentSnapshot extends DocumentSnapshot$1 {
  ...
  toJSON() {
    if (this.metadata.hasPendingWrites)
      throw new FirestoreError(C.FAILED_PRECONDITION, "DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
    const t = this._document, e = {};
    if (e.type = _DocumentSnapshot._jsonSchemaVersion, e.bundle = "", e.bundleSource = "DocumentSnapshot", e.bundleName = this._key.toString(), !t || !t.isValidDocument() || !t.isFoundDocument())
      return e;
...
function documentSnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
    if (e.bundle === zt2)
      throw new FirestoreError(C.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
    ...
    const i = o.documents;
    if (1 !== i.length)
      throw new FirestoreError(C.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${i.length} documents.`);
...
var QuerySnapshot = class _QuerySnapshot {
  ...
  toJSON() {
    if (this.metadata.hasPendingWrites)
      throw new FirestoreError(C.FAILED_PRECONDITION, "QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
    const t = {};
...
function querySnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
    ...
    if (1 !== o.queries.length)
      throw new FirestoreError(C.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${o.queries.length} queries.`);
  ...
  get(t) {
    ...
    return this._transaction.lookup([e._key]).then((t2) => {
      ...
      if (r.isFoundDocument())
        return new DocumentSnapshot$1(this._firestore, n, r.key, r, e.converter);
      if (r.isNoDocument())
        return new DocumentSnapshot$1(this._firestore, n, e._key, null, e.converter);
      throw fail(18433, {
        doc: r
      });
    });
...
function onSnapshot(t, ...e) {
  ...
  if (t instanceof DocumentReference)
    i = __PRIVATE_cast(t.firestore, Firestore), u = __PRIVATE_newQueryForPath(t._key.path), o = {
      next: (n2) => {
...
function onSnapshotResume(t, e, ...n) {
  ...
  if (s.error)
    throw new FirestoreError(C.INVALID_ARGUMENT, s.error);
  let a, o = 0;
...
function __PRIVATE_tryGetString(t, e) {
  if ("string" != typeof t[e])
    throw new FirestoreError(C.INVALID_ARGUMENT, "Missing string value for: " + e);
  return t[e];
}
...
function getPersistentCacheIndexManager(t) {
  ...
  if (e)
    return e;
  const n = ensureFirestoreConfigured(t);
  if ("persistent" !== ((_a = n._uninitializedComponentsProvider) == null ? void 0 : _a._offline.kind))
    return null;
